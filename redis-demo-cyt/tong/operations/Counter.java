...
public class Counter {
	...
	public static void main(String[] args) {
        ...
        // database
        counter.SetData(jedis, atoms);
        
        // search
        String key = "user3";
        int result = counter.Search(key, jedis);
        System.out.printf("Freqency for %s: %d", key, result);
	...
	// count frequency
	public int Search(String key, Jedis connection) {
